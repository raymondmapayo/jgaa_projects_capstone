import { Modal, notification } from "antd"; // Ant Design notification import
    ...
    if (validateForm()) {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          // Close the modal and trigger handleContinue when city and country are updated
          onClose(); // Close modal after save
          onContinue(); // Trigger the continue function
        }
      } catch (error) {
