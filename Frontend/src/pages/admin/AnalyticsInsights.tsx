...
const AdminAnalyticsInsights = () => {
  ...
  useEffect(() => {
    const fetchReservedTables = async () => {
      try {
        const response = await axios.get("http://localhost:8081/get_reserved");
    ...
    const fetchTotalCustomers = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8081/total_users_bytime"
        );
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        {/* Total Sales */}
        <div className="bg-white dark:text-white p-4 sm:p-6 rounded-lg shadow-md min-w-0 dark:bg-[#001f3f]">
        ...
        {/* Total Customers */}
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md min-w-0 dark:bg-[#001f3f]">
