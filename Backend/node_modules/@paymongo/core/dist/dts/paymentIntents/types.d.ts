...
export declare type PaymentIntentStatus = 'awaiting_payment_method' | 'awaiting_next_action' | 'processing' | 'succeeded';
...
export declare type RetrievePaymentIntentParams<UsingPublic extends boolean> = UsingPublic extends true ? RetrievePaymentIntentParamsUsingPublic : BaseRetrievePaymentIntentParams;
...
export declare type AttachPaymentIntentParams<UsingPublic extends boolean> = UsingPublic extends true ? AttachPaymentIntentParamsUsingPublic : BaseAttachPaymentIntentParams;
